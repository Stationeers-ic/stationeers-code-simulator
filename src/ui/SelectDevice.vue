...
<template>
	<Dropdown style="width: 100%" editable filter v-model="model" :options="devices" :loading="loading" optionLabel="name" optionValue="code" placeholder="Select a device" class="w-full md:w-14rem">
